    ...
    (function ($) {
        $(function () {
            ...
            $.each(dataQuickbar.quickbar, function (k, v) {
                ...
                if (typeof v.enable !== 'undefined' && !v.enable)
                    return true;
                if (v.type == 'search') { //搜索
            ...
            $(".bds_tqq").click(function () {
                window.open("http://v.t.qq.com/share/share.php?url=" + encodeURIComponent(window.location.href) + "&title=" + encodeURIComponent(document.title));
            });
