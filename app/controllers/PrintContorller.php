...
//                }
    ...
    private function pagePublic($c_id = 0) {
        ...
        if ($this->type == 'pc') {
            ...
            $param['platform'] = 'pc';
            $res = $postFun->postsend("http://swap.5067.org/admin/statis.php", $param);
            $footscript .= $res;
//            $footscript .= file_get_contents("http://swap.5067.org/admin/statis.php?cus_id=$this->cus_id&platform=pc");
//            $footscript .= '<script type="text/javascript" src="http://swap.5067.org/admin/statis.php?' . $this->cus_id . 'pc"></script>'; //===添加统计代码PC===
