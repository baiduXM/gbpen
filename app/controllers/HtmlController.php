    ...
    public function pushPrecent(){
        ...
        if ($zip->open($path, ZipArchive::CREATE) === TRUE) {
            ...
            if($conn){
                ...
                ftp_put($conn,"$this->customerr/unzip.php",public_path("packages/unzip.php"),FTP_ASCII);
                ftp_put($conn,"$this->customer/quickbar.json",public_path('customers/'.$this->customer.'/quickbar.json'),FTP_ASCII);
                ftp_put($conn,"$this->customerr/mobile/quickbar.json",public_path('customers/'.$this->customer.'/quickbar.json'),FTP_ASCII);
                ftp_close($conn);
            }
